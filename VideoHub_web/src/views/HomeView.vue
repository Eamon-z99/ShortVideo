      ...
      <div class="channel-container">
        ...
        <div class="channel-right">
          <div class="grid-containerb">
            <a href="#" class="grid-itemb"><img src="../assets/channel/专栏.png" class="grid-itemb-img">专栏</a>
            <a href="#" class="grid-itemb"><img src="../assets/channel/活动.png" class="grid-itemb-img">活动</a>
